...
| vLLM ROCm 后端 | **实验性** — 本机 `pip`/ROCm 7.2 预编译轮子**已验证不可用**；AMD `rocm/vllm` **gfx110X 容器 / 源码编译仍可继续验证**（尚未做 Dolphin 端到端）— [evidence/compatibility/](evidence/compatibility/vllm-rocm72-gfx1100.md) |
